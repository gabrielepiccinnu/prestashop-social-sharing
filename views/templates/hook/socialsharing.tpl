	...
	<p class="socialsharing_product list-inline no-print">
		{if $PS_SC_TWITTER}
			<button data-type="twitter" type="button" class="btn btn-default btn-twitter social-sharing">
				...
				<!-- <img src="{$link->getMediaLink("`$module_dir`img/twitter.svg")}" alt="Tweet" /> -->
			</button>
		{/if}
		{if $PS_SC_FACEBOOK}
			<button data-type="facebook" type="button" class="btn btn-default btn-facebook social-sharing">
				<i class="icon-facebook"></i> {l s="Share" mod='socialsharing'}
				<!-- <img src="{$link->getMediaLink("`$module_dir`img/facebook.svg")}" alt="Facebook" /> -->
			</button>
		{/if}
		{if $PS_SC_WHATSAPP}
			<button data-type="whatsapp" type="button" class="btn btn-default btn-whatsapp social-sharing">
				...
				<!-- <img src="{$link->getMediaLink("`$module_dir`img/whatsapp.svg")}" alt="WhatsApp" /> -->
			</button>
		{/if}
		{if $PS_SC_PINTEREST}
			<button data-type="pinterest" type="button" class="btn btn-default btn-pinterest social-sharing">
				<i class="icon-pinterest"></i> {l s="Pinterest" mod='socialsharing'}
				<!-- <img src="{$link->getMediaLink("`$module_dir`img/pinterest.svg")}" alt="Pinterest" /> -->
			</button>
		{/if}
	</p>
{/if}